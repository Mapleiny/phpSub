...
define("dataSource", ["require", "exports"], function (require, exports) {
    ...
    // station
    exports.StationsInfoData = sourceData.stations;
    // line
    // for (var lineName in sourceData.lines) {
    //     let line = sourceData.lines[lineName];
    // }
    exports.LinesInfoData = sourceData.lines;
    // map size
...
define("line", ["require", "exports", "dataSource", "shape"], function (require, exports, dataSource_1, shape_1) {
    ...
    var getStationLoaction = function (stationName) {
        return dataSource_1.StationsInfoData[stationName].loc;
    };
    var zoom = 1.2;
    var azimuth = {
    ...
    var converStationsToPoints = function (stations) {
        var pathPoints = [];
        for (var stationName in stations) {
            ...
            if (typeof maybeString == 'string') {
                ...
                var offsetKey = stationMMName.slice(6, 8);
                if (offsetKey) {
