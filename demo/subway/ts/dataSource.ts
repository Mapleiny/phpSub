...
export interface ILineInfoData{
    id : string;
    name : string;
    color : string;
    num : string;
    ...
    loc1 : Point;
    loc2 : Point;
    stations : {[key:string]:string|Point};
}

// station
export let StationsInfoData = sourceData.stations;
...
export let LinesInfoData = sourceData.lines;
